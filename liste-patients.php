...
try
{
	...
	$bdd = new PDO('mysql:host=localhost;dbname=hospitalE2N;charset=utf8', 'stephane', 'pomme');
}
catch(Exception $e)
{
...
$_SESSION['id'] = $donnees_patients['id'];
echo "<form method=\"post\" action=\"profil-patient.php\"><input type=\"text\" name=\"id\" value=".$_SESSION['id']." hidden><input type=\"submit\" name=\"details\" value=\"details\"></form>";
echo "***";
}
